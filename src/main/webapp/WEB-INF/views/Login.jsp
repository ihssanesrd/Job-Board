        ...
        <div class="col-md-6 contents">
          <div class="row justify-content-center">
            ...
            <div class="d-flex mb-5 align-items-center">
                <span class="caption"><a href="<c:url value="/Register"/>" class="forgot-pass">Don't Have An Account ?</a></span> 
                <span class="ml-auto"><a href="#" class="forgot-pass">Forgot Password</a></span> 
              </div>

              <input type="submit" value="Login" class="btn btn-block btn-primary" style="background-color: #007bff;">
